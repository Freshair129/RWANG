...
- ไม่ verify เองว่า acceptance ผ่านจริง — `done` เป็นการยืนยันจากคน/ผลลัพธ์ agent.
  อยากเข้มกว่านี้: เพิ่ม verify-task ต่อท้ายแต่ละ task (route ไป opus) ก่อน mark done.
